...
public partial class Admin_Adm_login : System.Web.UI.Page
{
    //第二步，获取配置连接信息
    ...
    protected void btnlogin_Click(object sender, EventArgs e)
    {
        ...
        {
            //第四步，写对数据库的操作语句
            string str = "select * from admin where adminName='" + txtusername.Text + "' and adminPassword='" + txtpassword.Text + "'";
